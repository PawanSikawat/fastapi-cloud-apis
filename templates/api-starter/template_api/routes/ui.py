...
async def login_submit(
    ...
    response.set_cookie("api_key", signed_key, httponly=True, samesite="lax", max_age=86400)
    return response
...
async def dashboard_page(request: Request) -> HTMLResponse:
    return templates.TemplateResponse(request, "dashboard.html", {"authenticated": True})
